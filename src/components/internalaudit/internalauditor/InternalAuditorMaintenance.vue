...
export default {
  ...
  methods: {
    ...
    loadData () {
      let vm = this
      this.$ajax.get('/api/internalauditor/internalAuditor/getInternalAuditor')
        .then(function (res) {
          console.log('internalAuditorMaintenance')
          console.log(res)
    ...
    onSubmit () {
      let vm = this
      this.$ajax.post('/api/internalauditor/internalAuditor/queryInternalAuditor', this.internalAuditorRequestForm)
        .then(function (res) {
