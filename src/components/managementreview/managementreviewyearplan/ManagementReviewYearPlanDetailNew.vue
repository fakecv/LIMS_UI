<template>
  <ManagementReviewYearPlanDetail
   ...
   v-on:updateManagementReviewYearPlanForm="updateManagementReviewYearPlanForm"
...
export default {
  ...
  methods: {
    updateManagementReviewYearPlanForm (event) {
      this.managementReviewYearPlanForm.id = event.id
    },
