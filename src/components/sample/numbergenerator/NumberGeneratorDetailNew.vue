<template>
  <NumberGeneratorDetail :numberGeneratorForm="numberGeneratorForm"
  v-on:updateNumberGeneratorForm="updateNumberGeneratorForm"
...
export default {
  ...
  methods: {
    updateNumberGeneratorForm (event) {
      this.numberGeneratorForm.id = event.id
    },
