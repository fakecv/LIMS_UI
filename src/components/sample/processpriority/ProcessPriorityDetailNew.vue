<template>
  <ProcessPriorityDetail :processPriorityForm="processPriorityForm"
  v-on:updateProcessPriorityForm="updateProcessPriorityForm"
...
export default {
  ...
  methods: {
    updateProcessPriorityForm (event) {
      this.processPriorityForm.id = event.id
    },
