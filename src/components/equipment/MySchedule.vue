  ...
  <div class="full-calendar-body">
    ...
    <div class="dates" ref="dates">
        ...
        <div class="week-row" v-for="(week,index) in currentDates" :key="index">
          <div class="day-cell" v-for="(day,index) in week"
            :class="{'today' : day.isToday,
              'not-cur-month' : !day.isCurMonth}" :key="index">
      ...
      <div class="dates-events">
        <div class="events-week" v-for="(week,index) in currentDates" :key="index">
          <div class="events-day" v-for="(day,index) in week" track-by="$index"
            :class="{'today' : day.isToday,
              'not-cur-month' : !day.isCurMonth}" @click.stop="dayClick(day.date, $event)" :key="index">
            <p class="day-number">{{day.monthDay}}</p>
            <div class="event-box">
              <p class="event-item" v-for="(event,index) in day.events" v-show="event.cellIndex <= eventLimit"
      ...
      <div class="more-events" v-show="showMore"
        ...
        <div class="more-body">
          <ul class="body-list">
            <li v-for="(index,event) in selectDay.events"
