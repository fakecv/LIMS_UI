<template>
  <SupplierAssessmentDetail
   ...
   v-on:updateSupplierAssessmentForm="updateSupplierAssessmentForm"
...
export default {
  ...
  methods: {
    updateSupplierAssessmentForm (event) {
      this.supplierAssessmentForm.id = event.id
    },
  ...
  activated () {
    this.resetSupplierAssessmentForm()
  }
}
</script>
