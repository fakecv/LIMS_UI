<template>
  <GeneralApplicanceCheckDetail
   ...
   v-on:updateGeneralApplicanceCheckForm="updateGeneralApplicanceCheckForm"
...
export default {
  ...
  methods: {
    updateGeneralApplicanceCheckForm (event) {
      this.generalApplicanceCheckForm.id = event.id
    },
