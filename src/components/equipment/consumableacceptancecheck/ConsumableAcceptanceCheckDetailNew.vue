<template>
  <ConsumableAcceptanceCheckDetail
   ...
   v-on:updateConsumableAcceptanceCheckForm="updateConsumableAcceptanceCheckForm"
...
export default {
  ...
  methods: {
    updateConsumableAcceptanceCheckForm (event) {
      this.consumableAcceptanceCheckForm.id = event.id
    },
