<template>
  <GeneralApplicanceRequestDetail
   ...
   v-on:updateGeneralApplicanceRequestForm="updateGeneralApplicanceRequestForm"
...
export default {
  ...
  methods: {
    updateGeneralApplicanceRequestForm (event) {
      this.generalApplicanceRequestForm.id = event.id
    },
