<template>
  <div class="c666">
    ...
    <el-tag class="item" v-popover:popinput>
      <icon name="input" :w="iconWidth" :h="iconHeight"></icon>
      <span>文本</span>
    </el-tag>
    <!-- 数字 -->
    <el-tag class="item" @click.native="addItem('number')">
      <icon name="number" :w="iconWidth" :h="iconHeight"></icon>
      <span>数字</span>
    </el-tag>
    <!-- 开关 -->
    <el-tag class="item" @click.native="addItem('switch')">
      <icon name="switch" :w="iconWidth" :h="iconHeight"></icon>
      <span>开关</span>
    </el-tag>
    <!-- 单选 -->
    ...
    <el-tag class="item" v-popover:popradio>
      <icon name="radio" :w="iconWidth" :h="iconHeight"></icon>
      <span>单选</span>
    </el-tag>
    <!-- 多选 -->
    ...
    <el-tag class="item" v-popover:popcheckbox>
      <icon name="checkbox" :w="iconWidth" :h="iconHeight"></icon>
      <span>多选</span>
    </el-tag>
    <!-- 下拉 -->
    ...
    <el-tag class="item" v-popover:popselect>
      <icon name="select" :w="iconWidth" :h="iconHeight"></icon>
      <span>下拉</span>
    </el-tag>
    <!-- 日期 -->
    ...
    <el-tag class="item" v-popover:popcascader>
      <icon name="cascader" :w="iconWidth" :h="iconHeight"></icon>
      <span>级联</span>
    </el-tag>
  </div>
</template>
